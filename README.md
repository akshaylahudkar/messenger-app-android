...
Mesibo Messenger is an open-source app with real-time messaging, voice, and video call features. This repo contains the source code for Mesibo Messenger App for Android. The GitHub repository for the iOS version is [here](https://github.com/mesibo/messenger-app-ios).
...
You can also download the complete Android Messenger source code as a [zip file](https://github.com/mesibo/messenger-app-android/archive/master.zip). Although simple, the downside of this approach is that you will have to download the complete source code every time it is updated on the repository. 
...
Log in using your phone number and OTP 123456. You can even start using the app you've just built to communicate with your family and friends.

## Key SDKs user in this project

These apps use the following [Mesibo SDKs](https://mesibo.com).
